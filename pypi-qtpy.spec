...
Source0  : https://files.pythonhosted.org/packages/70/01/392eba83c8e47b946b929d7c46e0f04b35e9671f8bb6fc36b6f7945b4de8/qtpy-2.4.3.tar.gz
...
%prep
%setup -q -n qtpy-2.4.3
cd %{_builddir}/qtpy-2.4.3
pushd ..
cp -a qtpy-2.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739374235
