...
Source0  : https://files.pythonhosted.org/packages/e5/10/51e0e50dd1e4a160c54ac0717b8ff11b2063d441e721c2037f61931cf38d/qtpy-2.4.2.tar.gz
...
%prep
%setup -q -n qtpy-2.4.2
cd %{_builddir}/qtpy-2.4.2
pushd ..
cp -a qtpy-2.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730823755
