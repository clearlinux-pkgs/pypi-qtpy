...
Source0  : https://files.pythonhosted.org/packages/49/a0/4510b8f848eb2e3d8ed58bca8f876525db43e90812108fccddd16f8cc251/QtPy-2.2.0.tar.gz
...
%prep
%setup -q -n QtPy-2.2.0
cd %{_builddir}/QtPy-2.2.0
pushd ..
cp -a QtPy-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660167081
